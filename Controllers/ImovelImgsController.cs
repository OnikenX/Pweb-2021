...
namespace Pweb_2021.Controllers
{
    public class ImovelImgsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ImovelImgId,pathToImage,ImovelId")] ImovelImg imovelImg)
        {
            ...
            ViewData["ImovelId"] = new SelectList(_context.Imoveis, "ImovelId", "ImovelId", imovelImg.ImovelId);
            return View(imovelImg);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ImovelImgId,pathToImage,ImovelId")] ImovelImg imovelImg)
        {
